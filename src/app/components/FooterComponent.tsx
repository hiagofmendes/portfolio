...
const navigation = {
  ...
  social: [
    ...
    },
    {
      ...
      icon: (props: any) => <FaLinkedin size={"23px"} />,
    },
  ],
};
...
export default function FooterComponent() {
  return (
    <footer className="bg-gray-900 h-auto relative isolate overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
        ...
        <p className="mt-10 text-center text-sm/6 text-gray-400">
          &copy; {new Date().getFullYear()} SX Tech. Todos direitos reservados.
        </p>
      </div>
    </footer>
  );
